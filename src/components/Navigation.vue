                    ...
                    <div class="options">
                        ...
                        <div class="option">
                            <router-link class="option" :to="{name: 'Admin'}">
                                <b-icon icon="person-lines-fill" class="icon" scale="1"></b-icon>
                                <p>Admin</p>
                            </router-link>
                        </div>
                        <div @click="signOut" class="option"> 
                                <b-icon icon="person-x-fill" class="icon" scale="1"></b-icon>
                                <p>Sign Out</p>
                        </div>
                    </div>
                 </div>
...
//comença amagat del tot
.mobile-nav-enter {
    transform: translateX(-250px);
}
//acaba em la posició donada
.mobile-nav-enter-to {
